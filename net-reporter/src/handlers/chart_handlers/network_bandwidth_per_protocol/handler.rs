...
use crate::handlers::chart_handlers::network_bandwidth_per_protocol::response::network_bandwidth_per_protocol::NetworkBandwidthPerProtocolResponse;
use crate::handlers::chart_handlers::network_bandwidth_per_protocol::response::protocol::ProtocolResponse;
...
#[derive(Default)]
pub struct NetworkBandwidthPerProtocolHandler {}

impl NetworkBandwidthPerProtocolHandler {
...
impl NetworkServiceHandler for NetworkBandwidthPerProtocolHandler {
    async fn handle(
        &self,
        connection_pool: Arc<Pool<Postgres>>,
    ...
    fn get_handler_type(&self) -> String {
        NetworkBandwidthPerProtocolRequestDTO::get_data_type().to_string()
    }
}
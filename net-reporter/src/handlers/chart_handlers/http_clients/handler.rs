...
use crate::handlers::chart_handlers::http_clients::response::http_client::HttpClientResponse;
use crate::handlers::chart_handlers::http_clients::response::http_clients::HttpClientsResponse;
...
#[derive(Default)]
pub struct HttpClientsHandler {}

impl HttpClientsHandler {
...
impl NetworkServiceHandler for HttpClientsHandler {
    async fn handle(
        &self,
        connection_pool: Arc<Pool<Postgres>>,
        ...
        let query = QueryBuilder::new(HTTP_CLIENTS_REQUEST_QUERY, 5)
    ...
    fn get_handler_type(&self) -> String {
        HttpClientsRequestDTO::get_data_type().to_string()
    }
}
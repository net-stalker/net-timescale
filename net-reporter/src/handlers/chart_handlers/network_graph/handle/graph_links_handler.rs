...
use crate::{handlers::chart_handlers::network_graph::response::graph_edge::GraphEdgeResponse, query_builder::{query_builder::QueryBuilder, sqlx_query_builder_wrapper::SqlxQueryBuilderWrapper}};
...
#[derive(Default)]
pub struct GraphLinksHandler {}

impl GraphLinksHandler {

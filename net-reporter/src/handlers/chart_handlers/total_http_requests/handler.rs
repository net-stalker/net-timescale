...
use crate::handlers::chart_handlers::total_http_requests::response::total_http_requests_bucket::TotalHttpRequestsBucketResponse;
use crate::handlers::chart_handlers::total_http_requests::response::total_http_requests::TotalHttpRequestsResponse;
...
#[derive(Default)]
pub struct TotalHttpRequestsHandler {}

impl TotalHttpRequestsHandler {
...
impl NetworkServiceHandler for TotalHttpRequestsHandler {
    async fn handle(
        &self,
        connection_pool: Arc<Pool<Postgres>>,
    ...
    fn get_handler_type(&self) -> String {
        RequestTotalHttpRequestsDTO::get_data_type().to_string()
    }
}
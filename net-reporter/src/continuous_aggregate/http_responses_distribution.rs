...
pub struct HttpResponsesDistributionAggregate {}
const CA_NAME: &str = "http_responses_distribution_aggregate";
#[async_trait::async_trait]
impl ContinuousAggregate for HttpResponsesDistributionAggregate {

...
CREATE INDEX IF NOT EXISTS idx_network_bandwidth_tenant_network ON Network_Bandwidth_Materialized_View (Tenant_ID, Network_ID);
...
CREATE INDEX IF NOT EXISTS idx_network_bandwidth_src_dst_ip ON Network_Bandwidth_Materialized_View (Src_IP, Dst_IP);

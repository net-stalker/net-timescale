...
CREATE INDEX IF NOT EXISTS idx_total_http_requests_tenant_network ON Total_Http_Requests_Materialized_View (Tenant_ID, Network_ID);
...
CREATE INDEX IF NOT EXISTS idx_total_http_requests_src_dst_ip ON Total_Http_Requests_Materialized_View (Src_IP, Dst_IP);

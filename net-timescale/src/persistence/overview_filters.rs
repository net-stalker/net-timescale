...
pub struct OverviewFiltersPersistence {
    // entries: Vec<>
}

// impl OverviewFiltersPersistence {
//     pub fn into_wrapped(self) -> Rc<dyn ChartGenerator> {
//         Rc::new(self)
//     }
// }
//
// impl From<OverviewFiltersPersistence> for NetworkBandwidthDTO {
//     fn from(value: OverviewFiltersPersistence) -> Self {
...
impl Persistence for OverviewFiltersPersistence {
    async fn get_chart_dto(
        &self,
        connection: &Pool<Postgres>,
        data: &Envelope
    ) -> Result<Rc<dyn API>, String> {
        todo!("wait for DTO structures implementation")
...
impl ChartGenerator for OverviewFiltersPersistence {
